...
public class RequestHandler implements Runnable {
    ...
    private void sendNonCachedToClient(String urlString) {
        ...
        try{
            ...
            System.out.println("NullPointerExveption ouverture du fichier ");
        }
        ...
        // Le fichier est un fichier texte
            ...
            proxyToServerConnection.setRequestProperty("Content-Language","en-US"); // remplir le champs libre "en-US " par le language.
    ...
    private void handleHTTPSRequest(String urlString){
            ...
            try {
                ...
                try {
                    byte[] buffer = new byte[1024]; // 4096 à se renseigner.
                    int read;
                    do {
    ...
    class ClientToServerHttpsTransmit implements Runnable {
        ...
        InputStream proxyToServerInputStream;
     ...
     */
    public clientToServerHttpsTransmit(InputStream.proxyToClientInputStream, OutputStream.proxyToServerOutputStream) {
